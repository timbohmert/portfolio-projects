...
class Trainer: 
    ...
    def attack_opp_trainer(self, opponent_trainer, selected_attack):
        if self.active_pokemon.ko == False:
            ...
            self.active_pokemon.attack(selected_attack, opponent_pokemon)
        else:
...
ash = Trainer([pokemon.pikachu], "Ash", {'lorem': 50, 'ipsum': 25}, pokemon.pikachu)

beth = Trainer([pokemon.squirtle, pokemon.charmander, pokemon.bulbasaur], "Beth", {'lorem': 50, 'ipsum': 25}, pokemon.squirtle)
